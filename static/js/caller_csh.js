...
for(var i = 0; i < 101; ++i) {
    (function (i) {
        ...
        $(value).click(function(e){
            $.ajax({
                type: "POST",
                url: "https://129.21.50.30:5000/gpio/" + i.toString(),
...
function put_shade_height(){
    $.get("https://129.21.50.30:5000/gpio/get/current", function(data, status){
...
$('#up').click(function(e){
    $.ajax({
        type: "POST",
        url: "https://129.21.50.30:5000/gpio/set/current/up",
        success: function() { console.log("SUCCESS");},
        error: function() { console.log("FAIL");}
    });
...
$('#down').click(function(e){
    $.ajax({
        type: "POST",
        url: "https://129.21.50.30:5000/gpio/set/current/down",
        success: function() { console.log("SUCCESS");},
        error: function() { console.log("FAIL");}
    });
...
$('#steps').click(function(e){
    ...
    $.ajax({
        type: "POST",
        url: "https://129.21.50.30:5000/gpio/set/steps/" + val,
        success: function() { console.log("SUCCESS");},
        error: function() { console.log("FAIL");}
    });
});
...
$('#move').click(function(e){
    ...
    $.ajax({
        type: "POST",
        url: "https://129.21.50.30:5000/gpio/move/" + val,
        success: function() { console.log("SUCCESS");},
        error: function() { console.log("FAIL");}
    });
