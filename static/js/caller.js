...
$('#up').click(function(e){
    $.ajax({
        type: "POST",
        url: "https://agoel-rpi.student.rit.edu:5000/gpio/set/current/up",
        success: function() { console.log("SUCCESS");},
        error: function() { console.log("FAIL");}
    });
...
$('#down').click(function(e){
    $.ajax({
        type: "POST",
        url: "https://agoel-rpi.student.rit.edu:5000/gpio/set/current/down",
        success: function() { console.log("SUCCESS");},
        error: function() { console.log("FAIL");}
    });
...
$('#steps').click(function(e){
    ...
    $.ajax({
        type: "POST",
        url: "https://agoel-rpi.student.rit.edu:5000/gpio/set/steps/" + val,
        success: function() { console.log("SUCCESS");},
        error: function() { console.log("FAIL");}
    });
});
...
$('#move').click(function(e){
    ...
    $.ajax({
        type: "POST",
        url: "https://agoel-rpi.student.rit.edu:5000/gpio/move/" + val,
        success: function() { console.log("SUCCESS");},
        error: function() { console.log("FAIL");}
    });
